<div id="content-single" class="content group">
	...
	<div class="hentry hentry-post blog-big group ">
		...
		<div class="meta group">
			...
			<p class="categories"><span>In: <a href="{{ route('articlesCat', ['cat_alias', $article->alias]) }}" title="View all posts in Design" rel="category tag">Design</a>, <a href="blog-big-image.html" title="View all posts in Happyness" rel="category tag">{{ $article->title }}</a></span></p>
